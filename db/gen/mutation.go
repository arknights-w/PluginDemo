...
func (m *ItemMutation) SetFile(b []byte) {
	m.file = &b
}

// File returns the value of the "file" field in the mutation.
func (m *ItemMutation) File() (r []byte, exists bool) {
	v := m.file
	if v == nil {
		return
	}
...
// OldFile returns the old "file" field's value of the Item entity.
// If the Item object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ItemMutation) OldFile(ctx context.Context) (v []byte, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ItemMutation) Fields() []string {
	...
	if m.file != nil {
		fields = append(fields, item.FieldFile)
	}
	if m.created_At != nil {
